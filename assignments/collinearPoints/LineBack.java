 ...
 *
 */
public class LineBack implements Comparable<LineBack>, Iterable<Point> {
    ...
    * Collection c.
    */
   public LineBack(Collection<Point> c) {
      line = new TreeSet<Point>();
      for (Point p : c) {
         add(p);
      }
    ...
    */
   @Override
   public int compareTo(LineBack that) {
   ...
   public boolean equals(Object obj) {
      ...
      if (!(obj instanceof LineBack)) {
         return false;
      }
      LineBack that = (LineBack) obj;
